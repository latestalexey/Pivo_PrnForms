...
#КонецОбласти
	...
	КонецЦикла;
	ДанныеСотрудника=ПолучениеДанных.ПолучитьДанныеПоСотруднику(СсылкаНаДокумент.РаботникиОрганизации[0].Сотрудник,СсылкаНаДокумент.Дата);
	Для Каждого Эл Из ДанныеСотрудника Цикл
		ЗаменитьШаблон(Документ,"["+Эл.Ключ+"]",Эл.Значение);
	КонецЦикла;
	ДанныеФизЛицаСотрудника=ПолучениеДанных.ПолучитьДанныеПоФизЛицу(СсылкаНаДокумент.РаботникиОрганизации[0].Сотрудник.ФизЛицо,СсылкаНаДокумент.Дата);
