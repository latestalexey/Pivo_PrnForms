...
//р/с [РасчСчетОрганизации] в [БанкОрганизации], к/с [КоррСчетОрганизации]
	...
	Если ЗначениеЗаполнено(ДанныеОрганизации.ЮрАдресОрганизации) Тогда
		РеквизитыОрганизации=РеквизитыОрганизации+"Юридический адрес: "+Символы.Таб+ДанныеОрганизации.ЮрАдресОрганизации+Символы.ПС+Символы.ВК;
	КонецЕсли;
	Если ЗначениеЗаполнено(ДанныеОрганизации.ФактАдресОрганизации) Тогда
		РеквизитыОрганизации=РеквизитыОрганизации+"Фактический адрес: "+Символы.Таб+ДанныеОрганизации.ФактАдресОрганизации+Символы.ПС+Символы.ВК;
	КонецЕсли;
	...
	Если ЗначениеЗаполнено(ДанныеОрганизации.ИНН) Тогда
		...
		КонецЕсли;
		РеквизитыОрганизации=РеквизитыОрганизации+Символы.ПС+Символы.ВК;
	КонецЕсли;
	
	Если ЗначениеЗаполнено(ДанныеОрганизации.БИК) и ЗначениеЗаполнено(ДанныеОрганизации.РасчСчетОрганизации) Тогда
		РеквизитыОрганизации=РеквизитыОрганизации+"БИК "+ДанныеОрганизации.БИК+" р/с "+ДанныеОрганизации.РасчСчетОрганизации+" в "+ДанныеОрганизации.БанкОрганизации+", к/с"+ДанныеОрганизации.КоррСчетОрганизации;
	КонецЕсли;
