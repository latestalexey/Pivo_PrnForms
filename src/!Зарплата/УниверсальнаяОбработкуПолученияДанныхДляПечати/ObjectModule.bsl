...
//р/с [РасчСчетОрганизации] в [БанкОрганизации], к/с [КоррСчетОрганизации]
	...
	Если ЗначениеЗаполнено(ДанныеОрганизации.ЮрАдресОрганизации) Тогда
		РеквизитыОрганизации=РеквизитыОрганизации+"Юридический адрес: "+Символы.Таб+ДанныеОрганизации.ЮрАдресОрганизации+Символ(13);
	КонецЕсли;
	Если ЗначениеЗаполнено(ДанныеОрганизации.ФактАдресОрганизации) Тогда
		РеквизитыОрганизации=РеквизитыОрганизации+"Фактический адрес: "+Символы.Таб+ДанныеОрганизации.ФактАдресОрганизации+Символ(13);
	КонецЕсли;
