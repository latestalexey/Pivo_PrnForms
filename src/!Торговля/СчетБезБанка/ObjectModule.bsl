...
Функция ПолучитьПараметрыПечатиСчетаЗаказа(ПечДокумент) Экспорт	
	...
	Если ТипЗнч(ПечДокумент.СтруктурнаяЕдиница) = Тип("СправочникСсылка.БанковскиеСчета") И не ДополнительныеПараметры.НайтиПоЗначению(ПечДокумент.СтруктурнаяЕдиница) Тогда
