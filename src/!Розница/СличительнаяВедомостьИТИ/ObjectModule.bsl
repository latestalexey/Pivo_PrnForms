...
Функция ПечатьИНВ19(МассивОбъектов, ОбъектыПечати)
	...
	Запрос.Текст="ВЫБРАТЬ
	             ...
	             |	СУММА(1) КАК Сумма,
	             |	ВТ_ДокументыСДатамиИнвентаризаций.ДатаПредыдущейИнвентариации
	             |ИЗ
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		//KAV
		ПредыдущаяИнвентаризация=ТаблицаКорректировок.Найти(ДанныеПечати.Ссылка,"ПересчетТоваров");
		Если ПредыдущаяИнвентаризация<>Неопределено Тогда
			ОбластьМакета.Параметры.ДатаПредыдущейИнвентаризации=ПредыдущаяИнвентаризация.ДатаПредыдущейИнвентариации;
		КонецЕсли;
