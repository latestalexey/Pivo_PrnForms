...
Функция ПечатьСправки(СсылкаНаОбъект)
	...
	АдресКонтрагента=АдресКонтрагента+Символы.ПС+ФормированиеПечатныхФорм.ОписаниеОрганизации(УправлениеКонтактнойИнформацией.СведенияОЮрФизЛице(СсылкаНаОбъект.Контрагент,Шапка.ДатаДок), "ФактическийАдрес");
