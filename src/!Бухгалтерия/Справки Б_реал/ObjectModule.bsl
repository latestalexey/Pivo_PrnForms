...
Функция ПечатьСправки(СсылкаНаОбъект)
	...
	Пока Выборка.Следующий() Цикл 
		...
		Если ВыборкаДетальныеЗаписи.Следующий() Тогда
			ОбластьМакета.Параметры.ФИОПродавца=ОбщегоНазначения.ФамилияИнициалыФизЛица(ВыборкаДетальныеЗаписи.ФизическоеЛицо)+", "+ВыборкаДетальныеЗаписи.Должность.Наименование;
		КонецЕсли;
